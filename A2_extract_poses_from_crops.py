...
def main():
    ...
    parser.add_argument("--experiment_dir", type=str, default="/home/itec/emanuele/pointstream/experiments/20260127_154624_sam_seg", help="Path to the experiment folder generated by A1_segment_with_sam.py")
