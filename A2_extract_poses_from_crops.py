...
def main():
    ...
    parser.add_argument("--experiment_dir", type=str, default="/home/itec/emanuele/pointstream/experiments/20260114_160726_yolo_seg", help="Path to the experiment folder generated by segment_with_yolo.py")
