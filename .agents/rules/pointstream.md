...
description: When working on pointstream: Object-centric semantic neural video codec. Instead of transmitting pixel residuals (H.264/HEVC/AV1), the encoder transmits semantic understanding — actor keypoints, camera poses, a background panorama, and a highly quantized residual video — and the client reconstructs frames with generative models
---
