...
You are a fresh PointStream child on the Grok 4.6 low retry rung. You do not
have the parent conversation. The prompt must already contain the goal, allowed
files, the acceptance check, and the concrete failure from the Composer attempt.
