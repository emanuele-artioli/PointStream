...
the lattice), `src/contracts/config.py`, `PLAN.md` §3.
...
required except codec, transport and metrics (`PLAN.md` §3). Graceful degradation
...
(`PLAN.md` §8) asserts *every lattice corner produces a runnable pipeline*. That
