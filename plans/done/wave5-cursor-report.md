...
Also open: [#23](https://github.com/emanuele-artioli/PointStream/pull/23) `plans/wave5` (this prompt + WAVE-2026-08-26). That PR's `plans/done/RESEARCH-HISTORY.md` §7 is the current wording. C and D each edited `plans/done/RESEARCH-HISTORY.md` against **main's older §7**, not against #23.
...
**Decision (b), recorded in this worktree's `plans/done/RESEARCH-HISTORY.md` §3 before other edits:**
...
D's plans/done/RESEARCH-HISTORY.md note on item 4 is against **main's stale §7** (still says item 1
...
### 4.2 `plans/done/RESEARCH-HISTORY.md`
...
C and D's `plans/done/RESEARCH-HISTORY.md` hunks do not overlap each other. Both overlap #23.
...
- **C ∩ D = two files, both conflict:** `plans/done/RESEARCH-HISTORY.md` and `tests/runner/test_tier_end_to_end.py`.
...
are the same intent) and D's new assertions. `plans/done/RESEARCH-HISTORY.md`: C added **§3** (`What
...
condemned. It is not a rewrite layer. Recorded at `plans/done/RESEARCH-HISTORY.md` §3 heading
...
**Unblocks plans/done/RESEARCH-HISTORY.md §7 P0 item 4's wiring blocker. Does not run the lattice.**
...
**plans/done/RESEARCH-HISTORY.md §7 P0 item 4 now reads:**
...
- Merging C and D: resolve `plans/done/RESEARCH-HISTORY.md` and `test_tier_end_to_end.py` as above.
