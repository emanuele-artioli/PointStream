...
# Pose ONNX inference – copied from Moore-AnimateAnyone without modification.
...
def preprocess(
    ...
    """Preprocess for RTMPose model inference."""
...
def bbox_xyxy2cs(
    ...
    """Transform bbox (x1, y1, x2, y2) to (center, scale)."""
    dim = bbox.ndim
    if dim == 1:
        bbox = bbox[None, :]
