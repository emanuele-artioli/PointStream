...
| [Evaluation](docs/areas/evaluation.md) | Gate A reopened; Gate B pass retracted; repaired instrument awaits new development evidence | `experiments/tier/protocol.py`; `experiments/tier/resolution_adaptive.py`; `EVAL-ACT-06`, `EVAL-ACT-07` |
