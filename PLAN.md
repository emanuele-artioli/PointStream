...
| [Evaluation](docs/areas/evaluation.md) | Client validity (`EVAL-ACT-09`, `GEN-ACT-08`) merged in #93; byte diagnosis (`EVAL-ACT-08`) proved background dominates low-rate floor | PR #93 (`e9f781f`), PR #95 (`697bc9f`); `outputs/development-recovery/wave2-byte-diagnosis.json`; `EVAL-ACT-10` |
...
| [Generation](docs/areas/generation.md) | Fail-closed client identity and dynamic start frames enforced; pix2pix and spade4tennis smoke passed on GPU 1 | `scripts/smoke_generator.py`; `outputs/development-recovery/wave2-pix2pix-smoke.json`; `GEN-ACT-09` |
