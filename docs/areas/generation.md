...
| Candidate Inventory & Verification | Overnight recovery (`ed1cb3c`) | Audited candidate checkpoints (`pix2pix`, `spade4tennis`, `controlnet`, `animate-anyone`). Confirmed paths, hashes, license tags, and conditioning modalities. |
...
| `GEN-ACT-04` | Complete | Validated evaluator before training | 2026-09-09 audit, overnight recovery (`ed1cb3c`) | **Generator readiness and bounded training**: Audited candidate checkpoints, verified native temporal inference and conditioning, restored the training evaluator (`evaluate_checkpoint`), and executed bounded training pilot. |
