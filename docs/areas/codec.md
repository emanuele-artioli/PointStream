...
PR #88 partially implements CODEC-ACT-05, but it remains incomplete: actual residual streams/full-range mapping exist; public client-output scoring, generation-enabled wire isolation and complete envelope accounting still fail audit. See [evaluation audit](evaluation.md#pr-88-audit--2026-09-10) and [next dispatch](../workflow/session/submission-search.md).
