...
Audit validation: stored comparison reproduction plus same-anchor and doubled-byte controls passed; documentation link/whitespace checks and the separate paper build are recorded in the audit PR. No new video encoding, recalibration or revised scientific pass was performed.
