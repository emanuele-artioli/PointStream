...
- [x] **Learned Codec Baselines:** Benchmark against at least one recent semantic codec (e.g., DVC or NeRV). **Done (2026-07-11):** from-scratch HNeRV, trained for real on `real_tennis.mp4`; loses to AV1/HEVC on bytes and quality but the comparison now exists with real numbers ([9](9_codec_baselines_report.md)).
